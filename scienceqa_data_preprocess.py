...
with open("./input/strange/scienceqa_train.json", 'w') as file:
    json.dump(train_annotation, file)

with open("./input/strange/scienceqa_test.json", 'w') as file:
    json.dump(test_annotation, file)

with open("./input/strange/scienceqa_val.json", 'w') as file:
